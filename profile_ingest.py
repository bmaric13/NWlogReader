"""Profile ingest bottlenecks for the 600MB file."""
import time, re, sys
from pathlib import Path

# Try to find the file
candidates = [
    'C:/Users/admin/Downloads/imgb-rka2-nsvl-el01-tech_support',
    'C:/Users/admin/Downloads/imgb-rka2-nsvl-el01-tech_support.txt',
    'C:/Users/admin/Downloads/imgb-rka2-nsvl-el01-tech_support.tgz',
]
path = None
for c in candidates:
    p = Path(c)
...
if not path:
    import glob
    found = glob.glob('C:/Users/admin/Downloads/imgb*')
    print("File not found. Downloads matches:", found)
    sys.exit(1)
